...
import { StudentEnrollComponent } from 'app/entities/svcStudent/student-enroll/student-enroll.component';
...
describe('Component Tests', () => {
    describe('StudentEnroll Management Component', () => {
        let comp: StudentEnrollComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(StudentEnrollComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.studentEnrolls[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
