package cc.orangejuice.srs.student.result.config.timezone;

import cc.orangejuice.srs.student.result.SvcStudentResultApp;
import cc.orangejuice.srs.student.result.config.SecurityBeanOverrideConfiguration;
import cc.orangejuice.srs.student.result.repository.timezone.DateTimeWrapper;
import cc.orangejuice.srs.student.result.repository.timezone.DateTimeWrapperRepository;
...
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, SvcStudentResultApp.class})
