...
import cc.orangejuice.srs.gateway.CloudGatewayApp;

import cc.orangejuice.srs.gateway.config.SecurityBeanOverrideConfiguration;

import cc.orangejuice.srs.gateway.domain.Student;
import cc.orangejuice.srs.gateway.repository.StudentRepository;
import cc.orangejuice.srs.gateway.service.StudentService;
import cc.orangejuice.srs.gateway.service.dto.StudentDTO;
import cc.orangejuice.srs.gateway.service.mapper.StudentMapper;
import cc.orangejuice.srs.gateway.web.rest.errors.ExceptionTranslator;
...
import static cc.orangejuice.srs.gateway.web.rest.TestUtil.createFormattingConversionService;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import cc.orangejuice.srs.gateway.domain.enumeration.Gender;
/**
...
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, CloudGatewayApp.class})
public class StudentResourceIntTest {
    ...
    private static final String DEFAULT_EMAIL = "Ic@t.nB";
    private static final String UPDATED_EMAIL = "A@..t0";
