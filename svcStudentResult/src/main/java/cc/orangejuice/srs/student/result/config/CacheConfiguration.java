...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("svcStudentResult");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("svcStudentResult");
        ...
        config.getMapConfigs().put("cc.orangejuice.srs.student.result.domain.*", initializeDomainMapConfig(jHipsterProperties));
