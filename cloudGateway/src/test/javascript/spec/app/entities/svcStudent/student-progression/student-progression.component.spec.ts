...
import { StudentProgressionComponent } from 'app/entities/svcStudent/student-progression/student-progression.component';
...
describe('Component Tests', () => {
    describe('StudentProgression Management Component', () => {
        let comp: StudentProgressionComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(StudentProgressionComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new StudentProgression(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.studentProgressions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
