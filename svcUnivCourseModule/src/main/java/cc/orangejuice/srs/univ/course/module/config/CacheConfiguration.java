...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("svcUnivCourseModule");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("svcUnivCourseModule");
        ...
        config.getMapConfigs().put("cc.orangejuice.srs.univ.course.module.domain.*", initializeDomainMapConfig(jHipsterProperties));
