...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("svcProgrammeModule");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("svcProgrammeModule");
        ...
        config.getMapConfigs().put("cc.orangejuice.srs.programme.module.domain.*", initializeDomainMapConfig(jHipsterProperties));
